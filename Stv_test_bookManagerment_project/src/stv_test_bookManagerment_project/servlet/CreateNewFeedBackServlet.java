 ...
 */
@WebServlet(urlPatterns = { "/createNewFeedbackProduct" })
public class CreateNewFeedBackServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CreateNewFeedBackServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getServletContext()
                .getRequestDispatcher("/WEB-INF/views/createNewFeedbackProductView.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (errorString == null) {
			try {
				DBUtils.insertNewFeedBack(conn, feedBack);
